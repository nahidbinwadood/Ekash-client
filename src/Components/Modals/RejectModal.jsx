...
const RejectModal = ({ setIsReject, isReject, modalRejectHandler, user,role}) => {
    return (
                ...
                >
                  <DialogPanel className="w-full h-56 max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                    ...
                    <div className="py-8 w-full">
                      <h2 className=" text-center">Are you sure to Reject <span className="font-semibold">{user.name}</span> ?</h2>
                    </div>
                    <hr className="mt-2 " />
                    ...
                    <div className="flex mt-4 justify-center  gap-5">
                      <button
                        ...
                        onClick={() => modalRejectHandler(role)}
                      >
                        Yes,Make him 
                      </button>
                      <button
...
RejectModal.propTypes = {
    ...
    modalRejectHandler: PropTypes.func,
    setIsReject: PropTypes.func,
